                                        ...
                                        <div className="roadbook-show-itinerary">
                                            ...
                                            <div>
                                                <ul className="roadbook-show-itinerary__step">
                                                    ...
                                                    <li><span className="location-icon"><FontAwesomeIcon icon={faMapMarkerAlt} /></span>10h15 - pause étang du canard</li>
                                                    <li className="distance"><span className="distance-icon">|</span>70 km</li>
                                                    <li><span className="restaurant-icon"><FontAwesomeIcon icon={faUtensils} /></span>12h30 - Pause repas au restaurant du cap</li>
                                                    <li className="distance"><span className="distance-icon">|</span>110 km</li>
                                                    <li><span className="visite-icon"><FontAwesomeIcon icon={faMonument} /></span>16h00 - Visite pointe du grouin</li>
                                                    <li className="distance"><span className="distance-icon">|</span>45 km</li>
                                                    <li><span className="hotel-icon"><FontAwesomeIcon icon={faBed} /></span>18h45 - Hotel de la gare</li>
